...
//----------------------------------------------------------------------------
void TemplateVC150::GenerateDx9 (const char* projectName)
{
    char prefix[128];
    sprintf_s(prefix, 128, "%sDx9_VC150", projectName);
    Generate(projectName, prefix, msDx9ProjectLines);
}
//----------------------------------------------------------------------------
void TemplateVC150::GenerateWgl (const char* projectName)
{
    char prefix[128];
    sprintf_s(prefix, 128, "%sWgl_VC150", projectName);
    Generate(projectName, prefix, msWglProjectLines);
}
//----------------------------------------------------------------------------
void TemplateVC150::Generate (const char* projectName, const char* prefix,
    char* projectLines[])
{
...
//----------------------------------------------------------------------------
char* TemplateVC150::msDx9ProjectLines[NUM_PROJECT_LINES] =
{
...
"  </ItemGroup>",
"  <ItemGroup>",
"    <ProjectReference Include = \"..\\..\\LibApplications\\LibDx9Applications_VC150.vcxproj\">",
"    <Project>{d070aff0-e688-4e38-9c89-ab016371b618}</Project>",
"    </ProjectReference>",
"    <ProjectReference Include = \"..\\..\\LibCore\\LibCore_VC150.vcxproj\">",
"    <Project>{4915b5b4-800b-40e2-a46b-703f8f38e066}</Project>",
"    </ProjectReference>",
"    <ProjectReference Include = \"..\\..\\LibGraphics\\LibDx9Graphics_VC150.vcxproj\">",
"    <Project>{63500b2e-1745-47a8-a4cc-ef1ab127c8a3}</Project>",
"    </ProjectReference>",
"    <ProjectReference Include = \"..\\..\\LibImagics\\LibImagics_VC150.vcxproj\">",
"    <Project>{280ab789-07ff-49fd-9fdd-4459ac601d24}</Project>",
"    </ProjectReference>",
"    <ProjectReference Include = \"..\\..\\LibMathematics\\LibMathematics_VC150.vcxproj\">",
"    <Project>{d7b74341-c2e2-470b-a375-3e97ceca3457}</Project>",
"    </ProjectReference>",
"    <ProjectReference Include = \"..\\..\\LibPhysics\\LibPhysics_VC150.vcxproj\">",
...
//----------------------------------------------------------------------------
char* TemplateVC150::msWglProjectLines[NUM_PROJECT_LINES] =
{
"﻿<?xml version=\"1.0\" encoding=\"utf-8\"?>",
"<Project DefaultTargets=\"Build\" ToolsVersion=\"15.0\" xmlns=\"http://schemas.microsoft.com/developer/msbuild/2003\">",
"  <ItemGroup Label=\"ProjectConfigurations\">",
...
//----------------------------------------------------------------------------
char* TemplateVC150::msFilterLines[NUM_FILTER_LINES] =
{
"﻿<?xml version=\"1.0\" encoding=\"utf-8\"?>",
